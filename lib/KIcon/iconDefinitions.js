...
const KolibriIcons = {
  ...
  copyToClipboard: {
    icon: require('./precompiled-icons/material-icons/content_copy/outline.vue').default,
    rtlFlip: true,
  },
  ...
  bookmark: { icon: require('./precompiled-icons/mdi/bookmark').default },
  bookmarkEmpty: { icon: require('./precompiled-icons/mdi/bookmark-outline').default },
};
